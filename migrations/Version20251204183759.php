 ...
 */
final class Version20251204183759 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD first_name VARCHAR(255) NOT NULL, ADD last_name VARCHAR(255) NOT NULL, ADD uuid CHAR(36) NOT NULL, ADD guest_number INT DEFAULT NULL, ADD allergy VARCHAR(255) DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP first_name, DROP last_name, DROP uuid, DROP guest_number, DROP allergy');
    }
}
